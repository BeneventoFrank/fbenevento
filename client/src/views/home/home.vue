...
<template>
    ...
    <div id='container' class='flexContainer mainContent'>

        <section id='homeImage' class='home'>
        ...
        <section class='flexContainer resumeSection'>
            <div class='flexContainer innerContainer'>
                <div class='job'>
